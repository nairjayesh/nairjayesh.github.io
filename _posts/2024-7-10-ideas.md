...
---
  Ideas I often find repeating to myself, written down to consolidate. 

- The point of wealth is to enable people to pursue things for their own sake, but ironically, sometimes the greatest wealth comes to people who pursue things for their own sake. 

- In programming you can perform iterations without the concept of a loop, instead relying on just linear recursion. (Boom!) It's the idea of what iterations are fundamentally, and what recursions are -- iterations are a special case of recursion, where you only depend upon the knowledge of the previous case in the counter. 

- Struggle is entirely pointless, a distraction, a time sink, a thing that hinders a person to get to a place. No matter how proud you are of your version of the rags to riches, the ill person to healthy, the addict to sober struggle stories. Imagine, what more you could dream or achieve, if you hadn't begun from your current place - alternatively, struggle is the thing you rely on the most, to justify your time and effort going down the drain - because you couldn't figure stuff out faster, or make better decisions earlier. 
...
- That almost anything else in the physical world, can be represented in computers and run as a simulation, this simple thing --new concepts and representations has led to computers entering almost every field, it's a tool for most - but it's a world in itself, nothing we've ever produced comes close to it. 
...
- Other persons ability to do well, to be productive, to be more knowledgeable , to create more wealth doesn't take away my ability to do the same, but envying it, or worse preventing them from doing it, or spending time criticizing them from doing well, to stop feeling like this, is what takes away my ability. 
